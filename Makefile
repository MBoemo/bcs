...
DEBUG = -g
LIBFLAGS =
CXXFLAGS = -pg -Wall -O3 -fopenmp -std=c++11 -I eigen-git-mirror $(DEBUG)
...
ifeq ($(UNAME),Darwin)
	...
	CXXFLAGS = -Wall -O3 -std=c++11 $(DEBUG) -I/usr/local/opt/llvm/include -I eigen-git-mirror -fopenmp -lstdc++
